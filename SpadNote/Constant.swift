...
enum Constant {
    static let appName = "SpadNote"
    static let launcherAppId = "com.nilon123456789.SpadNote"
    static let fileName = "savedText.rtfd"
    static let savePath = FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent(".SpadNote/")
}
